        ...
        <div class="container-fluid" id="fundoMain">
            <div class="row " id="cabecalhoMain"> 
                <div class="col-sm-2 text-light text-center">
                    <h3 class="display-4 my-auto" id="infoControl">hi, <%=u.getLogin()%></h3>
                </div>
                <div class="col-sm-8 text-center text-light my-auto">
                    <h1 class="display-3" id="titulo">users</h1>
                </div>
                <div class="col-sm-2 text-light text-center">
                    <a href="<%= request.getContextPath() + "/logout?n=" + u.getLogin()%>" ><h3 class="display-4 my-auto text-danger" id="infoControl">logout</h3></a>
                </div>
            </div>
            <div class="row " id="cabecalhoMain"> 
                    ...
                    <form id="formularioMain">
                        <div class="row ">
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" class="form-control" name="nameLogin" id="nameInput" placeholder="enter name" autofocus required/>
                            </div>
                            <div class="form-group col-sm-4">
